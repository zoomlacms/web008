...
.instside{margin-top: 1em;}
/*five points below the page*//*.instside .carousel-indicators{bottom:auto;}*//*.instside .carousel-indicators li{width:20px;height:20px;background-color: #09f;border:#09f;}
.instside .carousel-indicators .active{width:20px;height:20px;background-color: #ccc;border:#ccc;}*/#carousel_step{margin: 0 auto;width: 500px;}
...
/*licence*/.lic_btn{margin: auto;border-radius: 15px;line-height: 28px;height: 30px;border: 0px solid #333;background-color: #fff;background-size: 15px 15px;background-repeat: no-REPEAT;background-position: 5px center;color: #333;font-size: 14PX;width: 280px;cursor: pointer;}
...
.check_item_div .fa-check{color: #A5E360;margin-right: 10px;}
.check_item_div .fa-remove{color: red;margin-right: 10px;}
                    ...
                    <div class="container-fulid instcon">
                        ...
                        <div class="container text-left content_body" style="max-width: 740px; padding-left: 160px;">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TxtCustomPath" runat="server" data-enter="6" class="form-control text_300" Text="Admin" MaxLength="10" onkeyup="value=value.replace(/[^\w]/ig,'');" Title="<%$Resources:L,请输入最少三到十位英文数字组合 %>" />
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TxtSiteManageCode" runat="server" Text="8888" data-enter="7" class="form-control text_300" />
