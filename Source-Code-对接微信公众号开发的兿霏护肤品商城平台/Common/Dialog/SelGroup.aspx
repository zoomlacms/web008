...
.userlist_div{height:350px;margin-left:-5px;border-right:2px solid #ddd;overflow:auto;}
...
.selgroup_foot{padding-top:5px;line-height:30px;height:30px;border-top:1px solid #ddd;text-align:right;padding-right:20px;}
      ...
      <div class="container-fluid search_div">
        ...
        <div class="container-fluid selgroup_body">
            <div class="row">
                ...
                <div class="col-md-5 adduser_div">
                    <ul class="nav nav-tabs">
            ...
            <div class="selgroup_foot">
                <button type="button" onclick="SelUser()" class="btn btn-primary">确定选择</button>
            </div>
        </div>
</asp:Content>
