...
<%--        <li><a href="#Tabs5" data-toggle="tab">扩展配置</a></li>--%>
        ...
        <li><a href="#Tabs4" data-toggle="tab">会员菜单</a></li>
    ...
    <div class="tab-content panel-body padding0">
            ...
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox6" runat="server" class="form-control text_s"></asp:TextBox>
                            个字符
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox7" runat="server" class="form-control text_s"></asp:TextBox>
                            个字符
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox8" runat="server" TextMode="MultiLine" class="form-control m715-50" style="height:100px;"></asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="MobileCodeNum_T" CssClass="form-control text_s int" MaxLength="2" /><span>个字符</span>
                    ...
                    <tr><td><strong>Email是否必填</strong></td><td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtMobileRegInfo" runat="server" Rows="6" TextMode="MultiLine" class="form-control m715-50"></asp:TextBox></td>
                    </tr>
                </tbody>
                <tr id="#save">
        ...
        <div class="tab-pane" id="Tabs4">
            <table class="table table-striped table-bordered table-hover myform-control">
                <tbody>
                    <tr><td class="text-right text_300"><strong>会员中心主菜单：</strong></td><td>
                        ...
                        <label><input type="checkbox" name="UserNavBan" value="plat"/>能力</label>
                        <div class="rd_green margin_t5">*勾选的导航会禁止显示</div>
                    </td></tr>
                </tbody>
                <tr>
                    <td class="text-center" colspan="2">
