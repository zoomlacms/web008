<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteInfo.aspx.cs" MasterPageFile="~/Manage/I/Default.master" Inherits="ZoomLaCMS.Manage.Config.SiteInfo" ValidateRequest="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="LogoUrl_T" runat="server"  class="form-control text_300"></asp:TextBox>
            </td>
        </tr>
        <tr>
