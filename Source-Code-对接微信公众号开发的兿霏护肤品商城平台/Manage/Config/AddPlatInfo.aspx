<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPlatInfo.aspx.cs" Inherits="ZoomLaCMS.Manage.Config.AddPlatInfo" MasterPageFile="~/Manage/I/Default.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-striped">
        ...
        <tr id="AppID_Tr" runat="server">
            <td>APPID</td>
            <td>
                <ZL:TextBox runat="server" CssClass="form-control text_300" ID="APPID_T" /></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="PlatInfoList.aspx" id="Return_B" runat="server" class="btn btn-default">返回列表</a>
            </td>
        </tr>
    </table>
</asp:Content>
