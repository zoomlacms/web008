...
<table class="table table-striped table-bordered table-hover">
	<tbody>
		<tr>
			<td class="td_l"><strong>允许虚拟币支付：</strong></td>
			<td>
       ...
       <%-- <tr><td><strong><%=Resources.L.使用外币结算 %>：</strong>(<a href="../Shop/MoneyManage.aspx"><%=Resources.L.前往设置 %></a>)</td><td>
        ...
        <tr><td><strong>快递方式：</strong></td><td>
            <asp:TextBox runat="server" ID="ExpNames_T" class="form-control text_300"/>
            <span class="rd_green">示例格式:快递|平邮|EMS</span>
        </td></tr>
        <tr>
