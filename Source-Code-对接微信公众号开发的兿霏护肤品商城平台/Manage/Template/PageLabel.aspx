<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageLabel.aspx.cs" Inherits="ZoomLaCMS.Manage.Template.PageLabel" ValidateRequest="false" EnableViewStateMac="false" MasterPageFile="~/Manage/I/Default.master" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td class="tdbg" align="left">
                <asp:TextBox ID="TxtLabelName" class="l_input" CssClass="form-control" runat="server" Width="288px" />
        ...
        <tr>
            ...
            <td class="tdbg" align="left">
                <asp:TextBox ID="TxtLabelIntro" CssClass="form-control" class="l_input" runat="server"  TextMode="MultiLine" Columns="50" Rows="3" Height="60px"></asp:TextBox>
            </td>
        </tr>
        <tr class="tdbg">
