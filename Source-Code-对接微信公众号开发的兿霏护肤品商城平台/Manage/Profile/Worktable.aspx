<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Worktable.aspx.cs" Inherits="ZoomLaCMS.Manage.Profile.Worktable" MasterPageFile="~/Common/Master/Empty.master" %>
...
<div class="panel panel-info Worktable_well">
    ...
    <div class="panel-body">
        <ul class="link_menu" style="list-style-type: none;">
            ...
            <li class="litd"><a href="../Content/Model/ModelManage.aspx?ModelType=1"><i class="fa fa-edit"></i></a><br /><a href="../Content/ModelManage.aspx?ModelType=1" target="_self"><%=Resources.L.内容模型 %></a></li>
