<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BKConfig.aspx.cs" Inherits="ZoomLaCMS.Manage.Guest.BKConfig" MasterPageFile="~/Manage/I/Default.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="text-center">
        <asp:Button ID="Save_B" runat="server" OnClientClick="return CheckData()" OnClick="Save_B_Click" CssClass="btn btn-info" Text="保存配置" />
        <a href="javascript:;" onclick="clearData()" class="btn btn-info">重置参数</a>
    </div>
