<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="ZoomLaCMS.Manage.User.AddUser"  MasterPageFile="~/Manage/I/Default.master" %>
    ...
    <div>
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td style="width: 35%;">
                    <asp:DropDownList ID="DDLGroup" runat="server" TabIndex="8" onkeydown="return GetEnterCode('focus','tbTrueName');" class="btn btn-default dropdown-toggle text_md"></asp:DropDownList></td>
