        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_l">
                <ItemTemplate>
                    ...
                    <a href="MessageRead.aspx?id=<%# Eval("MsgID")%>" class="option_style"><i class="fa fa-eye" title="阅读"></i>阅读信息</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView> 
 ...
 <table class="table table-striped table-bordered">
        <tr>
            <td style="text-align:right;width:25%;">
                <asp:Button ID="Button2" runat="server" Text="批量删除" OnClientClick="return confirm('确定要删除这些记录吗？');" OnClick="Button2_Click" class="btn btn-primary pull" />
