...
.order_img {display: none;}.row{margin-bottom:25px;} .popover{max-width:250px;margin-top:10px;}
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
 ...
 <%--               <td><%=Resources.L.工号 %></td>--%>
                ...
                <ItemTemplate>
                    <tr ondblclick="location='UserInfo.aspx?id=<%# Eval("UserID") %>';">
                        ...
                        <td>
                            ...
                            <div class="popover right" style="width:230px;left:100%; top:-75px; margin-top:0;">
                                <div class="arrow"></div>
                                <h3 class="popover-title">概览</h3>
    ...
    <div class="input-group margin_t5" style="display:inline-block;">
        <asp:DropDownList ID="UserGroup_DP" CssClass="form-control text_md" runat="server" DataValueField="GroupID" DataTextField="GroupName"></asp:DropDownList>
        <span class="input-group-btn">
