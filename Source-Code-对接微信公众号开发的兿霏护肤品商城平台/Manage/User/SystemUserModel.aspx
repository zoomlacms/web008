<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemUserModel.aspx.cs" Inherits="ZoomLaCMS.Manage.User.SystemUserModel"   MasterPageFile="~/Manage/I/Default.master"%>
<asp:Content runat="server" ContentPlaceHolderID="head"><title>会员模型字段列表</title></asp:Content>
