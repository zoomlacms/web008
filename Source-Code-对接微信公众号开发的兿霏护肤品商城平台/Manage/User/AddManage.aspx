            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr id="showmenu" runat="server">
                    <td class="title" colspan="2">
                        <label><input type="checkbox" runat="server" id="AddUser_Chk" checked="checked" onclick="hideAdmin(this);"/>添加同名用户</label>
                    </td>
                </tr>
                <tbody runat="server" id="SameNameDiv">
                    ...
                    <tr>
                        ...
                        <td>
                            <ZL:TextBox ID="tbAnswer" runat="server" class="form-control text_300" ValidType="String" />
                    </tr>
                    <tr>
                        <td align="right">Email： </td>
                        <td>
                            <ZL:TextBox runat="server" ID="tbEmail" CssClass="form-control text_300" ValidType="Mail"></ZL:TextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
