...
<asp:TextBox runat="server" ID="AdminN_T" TabIndex="1" data-enter="1" size="20"  class="form-control input-control" autocomplete="off" placeholder="帐户"  autofocus="true"/></li>
<li><i class="fa fa-lock"></i>
<asp:TextBox runat="server" ID="AdminP_T" TabIndex="2" data-enter="2" TextMode="Password" MaxLength="18" AllowEmpty="false"
...
<script>
    ...
    function ajaxlogin() {
        if (!loginflag) {
            ...
            $("#IbtnEnter").val('登录中..');
            $.post("", { action: 'login', user: $("#<%=AdminN_T.ClientID%>").val(), pwd: $("#<%=AdminP_T.ClientID%>").val(), VCode_hid: $("#VCode_hid").val(), vcode: $("#VCode").val(), zncode: $("#ZnCode_T").val() },
                function (data) {
