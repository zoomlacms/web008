...
<link rel="stylesheet" type="text/css" href="/App_Themes/V3.css?version=<%:ZoomLa.BLL.BLLCommon.Version_JS %>" />
...
<form id="form1" runat="server">
    ...
    <div class="m_top">
                ...
                <td>
                    <div class="margin-15 padding0 m_top_right">
                        ...
                        <div class="col-lg-3 col-md-2 col-sm-3 col-xs-12 padding0 m_top_rl" style="padding-right: 20px;">
                            <div id="Announce">
                                <div class="pull-right hidden-xs Announce_r">
                                    <a href="javascript:;" onClick="ShowManageLeft();"><i class="fa fa-bars"></i></a>
                                </div>
        ...
        <div class="m_top_bottom hidden-xs">
                ...
                <li class="menu2_4">
                    <div class="btn-group topdrop">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="javascript:;" onclick="showleft('menu2_4','Content/Model/ModelManage.aspx?ModelType=7')"><%=Resources.L.互动模型 %></a></li>
                ...
                <li class="menu3_13">
                    <div class="btn-group topdrop">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="javascript:;" data-url="UserShopManage/StoreStyle.aspx">店铺样式</a></li>
                            <li><a href="javascript:;" data-url="Content/Model/ModelManage.aspx?ModelType=5">商品模型</a></li>
                            <li><a href="javascript:;" data-url="Content/Model/ModelManage.aspx?ModelType=6">申请模型</a></li>
            ...
            <ul class="menu4">
                ...
                <li class="menu4_5"><a onclick="showleft('menu4_5','Content/Model/ModelManage.aspx?ModelType=10')">模型管理</a></li>
                <li class="menu4_4"><a onclick="showleft('menu4_2','/AdminMVC/Page/PageTemplate?ID=-1')">公用栏目</a></li>
            ...
            <ul class="menu7">
                <li class="menu7_1 active"><a onclick="showleft('menu7_1','Config/DBTools/Default.aspx')"><%=Resources.L.开发中心 %></a></li>
                ...
                <li class="menu8_10"><a onclick="showleft('menu8_10','Addon/Plugins/Default.aspx')">插件管理</a></li>
            ...
            <ul class="menu8">
                ...
                <li class="menu8_2"><a onclick="showleft('menu8_2','Content/Model/ModelManage.aspx?ModelType=1')"><%=Resources.L.模型管理 %></a></li>
                ...
                <li class="menu10_7"><a onclick="showleft('menu10_7','Amazing/css/Default.aspx')">百变微站</a></li>
                <li class="menu8_9"><a onclick="showleft('menu10_7','Addon/FontIcon/Default.aspx')">字库与图标</a></li>
                <li class="menu8_8"><a onclick="showleft('menu8_8','Pay/PayPlatManage.aspx')">支付中心</a></li>
            </ul>
            <ul class="menu9">
            ...
            <ul class="menu10">
                ...
                <li class="menu10_5"><a onclick="showleft('menu10_5','TouTiao/TouTiaoContent.aspx');">头条管理</a></li>
    ...
    <div class="m_main">
            ...
            <ul class="list-unstyled">
                ...
                <!--<li id="menu3_8_11"><a href="javascript:;" data-url="Shop/profile/LmUserManage.aspx">联盟会员</a></li>-->
                    ...
                    <ul id="menu3_13" class="m_left_ulin">
                        ...
                        <li id="menu3_13_3"><a href="javascript:;" data-url="UserShopManage/StoreStyle.aspx">店铺样式</a></li>
                        <li id="menu3_13_4"><a href="javascript:ShowMain('UserShopNodeTree.ascx','Shop/ProductManage.aspx?StoreID=-1',this);">店铺商品</a></li>
                        <li id="menu3_13_2"><a href="javascript:;" data-url="Content/Model/ModelManage.aspx?ModelType=6">申请模型</a></li>
                        <li id="menu3_13_11"><a href="javascript:;" data-url="UserShopManage/ShopGrade.aspx">等级管理</a></li>
                        <li id="menu3_13_15"><a href="javascript:;" data-url="UserShopManage/ShopMailConfig.aspx">邮件管理</a></li>
                        <li id="menu3_13_16"><a href="javascript:;" data-url="UserShopManage/DeliveryMan.aspx">送货员</a></li>
                    </ul>
                </div>
                ...
                <div id="menu8" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu8_10">
                        <li class="menu_tit"><span class="fa fa-chevron-down"></span>插件管理</li>
                        <li id="menu8_10_1"><a href="javascript:;" data-url="Addon/Plugins/Default.aspx">插件信息</a></li>
                    </ul>
                </div>
		...
		<li id="menu9_2_4"><a href="javascript:;" data-url="AddOn/StructAnalysis.aspx"><%=Resources.L.分析结构%></a></li>--%>
                ...
                <div id="menu10" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu10_5">
                        <li class="menu_tit"><span class="fa fa-chevron-down"></span>头条管理</li>
                    ...
                    <ul class="m_left_ulin" id="menu10_7">
                        <li class="menu_tit"><span class="fa fa-chevron-down"></span>百变微站</li>
        ...
        <div class="m_tips">
        	当前有<a href="/Admin/Content/ContentManage.aspx?NodeID=0&type=2" target="main_right"><span><%Call.Label("{ZL.Label id=\"获取未审核内容总数\" /}");%></span></a>条内容需审核<br/>
            当前有<a href="/Admin/Content/CommentManage.aspx?type=2" target="main_right"><span><%Call.Label("{ZL.Label id=\"获取待审核评论总数\" /}");%></span></a>条评论需审核<br/>
            当前有<a href="/Admin/Shop/OrderList.aspx" target="main_right"><span><%Call.Label("{ZL.Label id=\"获取待确认订单总数\" /}");%></span></a>个订单需确认
        </div>
        <div class="m_tips_c"><a href="javascript:;" onClick="HideTips();" title="点击关闭" style="display:block; border:1px solid #ccc; border-radius:50%; width:1.5em; height:1.5em; text-align:center; color:#ccc; line-height:1.3em; background:#fff;"><i class="fa fa-close"></i></a></div>
    ...
    <div class="manage_mobilemenu">
    	...
    	<div class="manage_mobilemenu_c">
            <ul>
                ...
                <li><a href="<%= CustomerPageAction.customPath2 %>SignOut.aspx" title="退出系统"><i class="fa fa-power-off"></i> 退出系统</a></li>
            </ul>
		</div>
    </div>
<style>
.m_tips { position:fixed; bottom:15px; right:15px; padding-left:20px; padding-right:20px; padding-top:15px; padding-bottom:15px; z-index:2000; border-radius:4px;border:1px solid #ccc; background:#fff;}
.m_tips span { color:#c00; font-weight:bold;}
.m_tips_c { position:fixed; bottom:97px; right:10px; z-index:2001;}
</style>
...
function HideTips(){
	$(".m_tips_c i").toggleClass("fa-plus");
	$(".m_tips").slideToggle();
}
</script>
</form>
