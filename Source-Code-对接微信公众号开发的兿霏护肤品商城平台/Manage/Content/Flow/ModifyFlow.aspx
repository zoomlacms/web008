...
<asp:Content runat="server" ContentPlaceHolderID="head"><title>审核状态</title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr><td></td>
            <td>
                <asp:Button ID="btnSave" runat="server" class="btn btn-primary" Text="保存信息" OnClick="btnSave_Click" />
