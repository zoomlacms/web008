...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-striped">
        <tr>
            <td style="width:300px;"><strong>版位名称：</strong></td>
            <td>
                <asp:TextBox ID="TxtZoneName" class="form-control text_300" runat="server" MaxLength="100"></asp:TextBox>&nbsp;*
        ...
        <tr>
            <td><strong>版位尺寸：</strong><br />
                IAB：互联网广告联合会标准尺寸。<br />
                带*号的为新增加的标准广告尺寸。 </td>
            <td>
                <div class="input-group m715-50">
                    <span class="input-group-addon">版位类型</span>
                    <asp:DropDownList ID="DropAdZoneSize" CssClass="form-control" runat="server" EnableViewState="False">
                    ...
                    <asp:TextBox ID="TxtZoneWidth"  runat="server" CssClass="form-control text_s" MaxLength="4" Text="468"></asp:TextBox>
                    <span class="input-group-addon">高度</span>
                    <asp:TextBox ID="TxtZoneHeight" runat="server" CssClass="form-control text_s" MaxLength="4" Text="60"></asp:TextBox>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td>
                <asp:Button ID="EBtnAdZone" runat="server" OnClick="EBtnAdZone_Click" Text="保存信息" class="btn btn-primary" />
                <input id="Cancel" name="Cancel" onclick="GoBack();" style="cursor: pointer" type="button" value="返回列表" class="btn btn-primary" />
            </td>
        </tr>
    </table>
</asp:Content>
