<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADZoneManage.aspx.cs" Inherits="ZoomLaCMS.Manage.Plus.ADZoneManage" MasterPageFile="~/Manage/I/Default.master" %>
...
<%--    <div class="input-group text_300 pull-right">
    ...
    <ol id="BreadNav" class="breadcrumb navbar-fixed-top">
        ...
        <li><a href="ADZoneManage.aspx">扩展功能</a></li>
        <li><a href="ADZoneManage.aspx">广告管理</a></li>
        <li class="active"><a href="ADManage.aspx">版位管理</a><a href="ADZone.aspx">[添加版位]</a></li>
        ...
        <div id="sel_box" class="padding5">
            <div class="input-group">
                <asp:TextBox runat="server"  id="skey" class="form-control mvcparam" placeholder="请输入广告名称或广告ID" onkeypress="selbox.search();" />
                <span class="input-group-btn">
                    <asp:LinkButton runat="server" class="btn btn-default" ID="Search_Btn" OnClick="BntSearch_Click"><i class="fa fa-search"></i></asp:LinkButton>
                </span>
            </div>
        </div>
    </ol>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_l">
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Copy" CommandArgument='<%# Eval("ZoneID") %>' CssClass="option_style"><i class="fa fa-copy" title="复制"></i>复制</asp:LinkButton>
            ...
            <asp:TemplateField HeaderText="版位" ItemStyle-CssClass="td_l">
                <ItemTemplate>
