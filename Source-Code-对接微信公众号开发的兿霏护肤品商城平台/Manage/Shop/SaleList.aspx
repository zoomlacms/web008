<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleList.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.SaleList"  MasterPageFile="~/Manage/I/Default.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ZL:ExGridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="Orderlistid" PageSize="20" OnRowDataBound="Egv_RowDataBound" OnPageIndexChanging="Egv_PageIndexChanging" IsHoldState="false" AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-hover" EnableTheming="False" EnableModelValidation="True" EmptyDataText="暂无销售记录！">
        <Columns>
