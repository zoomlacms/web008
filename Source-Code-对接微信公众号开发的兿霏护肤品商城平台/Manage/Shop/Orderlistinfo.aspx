    ...
    <div role="tabpanel" class="tab-pane" id="Logistics">
                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>发票信息：</td>
                            <td>
                                <asp:Label ID="Invoice" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td>缺货处理：</td>
                            <td>
        ...
        <div class="col-md-6">
            ...
            <div class="panel-footer text-center">
                <a href="javascript:;" class="btn btn-primary" onclick=' ShowComDiag("../iServer/BiServer.aspx?orderid=<%:Mid %>","服务记录");'>查看服务记录</a>
            </div>
        </div>
    </div>
...
<table class="table table-striped table-bordered table-hover">
    ...
    <tr>
        ...
        <td>
            ...
            <div class="margin_t5">
                <button runat="server" type="button" class="btn btn-info" id="Pay_Settle_Btn" onclick="orderSettle();">订单结算</button>
