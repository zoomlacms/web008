<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderList.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.OrderList" MasterPageFile="~/Common/Master/Empty.master" %>
            ...
            <ol id="BreadNav" class="breadcrumb navbar-fixed-top">
                ...
                <div id="sel_box" style="height:90px;border-top:1px solid #ddd;">
                    ...
                    <div class="input-group margin_t5" style="display: inline-block;">
                        <asp:DropDownList runat="server" ID="StoreType_DP" class="form-control text_md">
                        ...
                        <span class="input-group-btn">
                            <asp:Button runat="server" ID="Skey_Btn" class="btn btn-primary" OnClick="Skey_Btn_Click" Text="查询" />
...
<div id="maindiv">
    <ul id="ordernav" class="nav nav-tabs margin_t5">
       <li data-type="all"><a href="<%=BaseUrl %>"><asp:Label runat="server" ID="order_all_l" Text="全部订单"></asp:Label></a></li>
       <li data-type="unpaid"><a href="<%=BaseUrl %>&filter=unpaid"><asp:Label runat="server" ID="order_unpaid_l" Text="待付款"></asp:Label></a></li>
       <li data-type="prepay"><a href="<%=BaseUrl %>&filter=prepay"><asp:Label runat="server" ID="order_prepay_l" Text="预付款"></asp:Label></a></li>
       <li data-type="paid"><a href="<%=BaseUrl %>&filter=paid"><asp:Label runat="server" ID="order_paid_l" Text="已付款"></asp:Label></a></li>
       <li data-type="unexp"><a href="<%=BaseUrl %>&filter=unexp"><asp:Label runat="server" ID="order_unexp_l" Text="待发货"></asp:Label></a></li>
       <li data-type="exped"><a href="<%=BaseUrl %>&filter=exped"><asp:Label runat="server" ID="order_exped_l" Text="已发货"></asp:Label></a></li>
       <li data-type="finished"><a href="<%=BaseUrl %>&filter=finished"><asp:Label runat="server" ID="order_finished_l" Text="交易完成"></asp:Label></a></li>
       <li data-type="unrefund"><a href="<%=BaseUrl %>&filter=unrefund"><asp:Label runat="server" ID="order_unrefund_l" Text="待退款"></asp:Label></a></li>
       <li data-type="refunded"><a href="<%=BaseUrl %>&filter=refunded"><asp:Label runat="server" ID="order_refunded_l" Text="退款完成"></asp:Label></a></li>
       <li data-type="recycle"><a href="<%=BaseUrl %>&filter=recycle"><asp:Label runat="server" ID="order_recycle_l" Text="回收站"></asp:Label></a></li>
    </ul>
...
.opdiv{position:fixed;bottom:0px;padding:10px; text-align:center;background-color:rgba(0, 0, 0, 0.40);width:100%;border-radius:4px;box-shadow:0 5px 10px rgba(0,0,0,.2);margin-bottom:20px;}
</style>
