...
function DupTitleFunc(title) {
    ...
    $.post("/AdminMVC/Content/Content_API", { action: "duptitle", value: title }, function (data) {
...
conhelp.verbak.showDiag = function () {
    ShowDiag("/AdminMVC/Content/Addon_VerBak?GeneralID=" + zlconfig.gid, "存档备份 <span class='rd_green'>(版本历史存于ZL_Content_VerBak表中)</span>");
}