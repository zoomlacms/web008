...
ZL_Dialog.prototype = {
    ShowModal: function (_url,_title) {
        ...
        var bodyhtml = "", Opion = "", foot = "", closeStyle = ref.isBigClose ? "<span class='fa fa-times-circle-o'>Close</span>" : "×", closeStyle = ref.closebtn ? closeStyle : "";
        if (ref.ajaxurl && ref.ajaxurl != "") {//ajax加载
            ...
            Opion = ref.maxbtn ? "<button type='button' id='BigOpion' title='全屏' class='close' style='width:30px;'><i class='fa fa-arrows-alt'></i></button>" : "";
