...
iconSelctor.prototype.tlp = '<input type="text" id="icon_text_@id" class="form-control text_300" /> <button type="button" id="icon_btn_@id" class="btn btn-info">图片地址或奥森图标</button> <span id="icon_span_@id"></span>';
...
iconSelctor.prototype.ShowDiag = function () {
    var ref = this;
    ref.diag.title = "选择图标";
    ref.diag.ajaxurl = "/Common/icon2.html?ver=2";
