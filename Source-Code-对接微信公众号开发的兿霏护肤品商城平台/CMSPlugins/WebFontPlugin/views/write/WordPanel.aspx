    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="margint5 text-center" style="width:600px;">
                ...
                <input type="button" value="书与回放" id="RelpyCanvas" class="btn btn-info" />
    ...
    var global = window;
        ...
        (function () {
            ...
            function r() {
                ...
                if ("number" == typeof window.orientation && 0 !== window.orientation) alert(k.a1 || "\u8bf7\u65cb\u8f6c\u60a8\u7684\u624b\u673a\u4e3a\u7ad6\u5c4f\u72b6\u6001\uff0c\u5728\u6a2a\u5c4f\u72b6\u6001\u4e0b\u65e0\u6cd5\u4f7f\u7528\uff01"),
                a();
                else {
                    r = null;
                    var d = hwrite.canvas;
                    ...
                    function ReWrite() {
                        ...
                        function write() {
                            ...
                            _vSetTimeOut = setTimeout(write, 13)
                        }
                        write()
                    }
                    g("editor")
...
<script>
    ...
    editor.newfont = function () {
        ...
        var postJson = { "writeid": editor.wordMod.writeid, "id": editor.wordMod.id };
        postJson.base64 = base64;
        $.post(editor.api + "savewrite", postJson, function (data) {
            var model = APIResult.getModel(data);
            if (APIResult.isok(model)) {
                Potrace.loadImageFromUrl(model.result);
                Potrace.process(function () {
                    //生成svg
                    delete postJson.base64;
