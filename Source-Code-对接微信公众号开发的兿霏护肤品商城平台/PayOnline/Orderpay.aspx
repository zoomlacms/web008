...
.head_div { text-align:center;}
.head_div img { height:4em;}
</style>
</asp:Content>
...
<div class="head_div"><a href="/"><img src="<%Call.Label("{$LogoUrl/}"); %>" /></a></div>
<div class="container">
                ...
                <div runat="server" id="virtual_ul">
                    ...
                    <ul class="dashpay_ul margin_t5">
                        <li runat="server" id="purseli" title="用户余额支付" visible="false">
                            ...
                            <div class='pay_btn' style="display:inline-block;"><i class="fa fa-credit-card"></i> 余额支付</div>
                        </li>
                        <li runat="server" id="siconli" title="用户银币支付" visible="false">
                            <input type="radio" name="payplat_rad" value="SilverCoin" />
                            <div class='pay_btn' style="display:inline-block;><i class="fa fa-rouble"></i> 银币支付</div>
                        </li>
                        <li runat="server" id="pointli" title="用户积分支付" visible="false">
                            <input type="radio" name="payplat_rad" value="Score" />
                            <div class='pay_btn' style="display:inline-block;"><i class="fa fa-money"></i> 积分支付</div>
                        </li>
                    </ul>
                </div>
