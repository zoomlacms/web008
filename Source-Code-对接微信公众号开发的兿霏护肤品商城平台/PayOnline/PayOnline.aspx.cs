                    ...
                    switch ((M_PayPlat.Plat)payPlat.PayClass)//现仅开通 12:支付宝即时到账和支付宝网银服务,15支付宝网银服务(上方代码中处理),银币与余额服务
                    {
                        ...
                        case M_PayPlat.Plat.WXPay:
                            #region 微信扫码支付
                            {
                                ...
                                {
                                    Response.Redirect("/API/pay/wxpay_mp.aspx?PayNo=" + pinfo.PayNo + "&SuccessUrl=/User/Order/OrderList");
                                }
                                else
                                {
                                    ...
                                    wxdata.SetValue("product_id", pinfo.PayNo);
                        ...
                        case M_PayPlat.Plat.Bill:
                            function.WriteErrMsg("快钱支付接口尚未配置");
                            break;
                        case M_PayPlat.Plat.PayPal:
                            function.WriteErrMsg("PayPal支付接口尚未配置");
                            break;
                        default:
