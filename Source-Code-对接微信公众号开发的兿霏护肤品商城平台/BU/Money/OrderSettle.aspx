...
<table class="table table-bordered table-striped">
    ...
    <tr><td></td><td><asp:Button runat="server" ID="Save_Btn" Text="结算订单" OnClick="Save_Btn_Click" OnClientClick="return confirm('确定要结算吗,将会同步修改已支付数据');" class="btn btn-primary"/></td></tr>
</table>
</div>
</asp:Content>
