...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ul class="list-unstyled" id="doclist_ul">    
        ...
        <li><a href="javascript:;" data-url="doc/FiledList.aspx" class="oaleftul"><i class="fa fa-chevron-circle-right"></i>归档公文</a></li>
        <li><a href="javascript:;" data-url="doc/BorrowList.aspx" class="oaleftul"><i class="fa fa-chevron-circle-right"></i>借阅列表</a></li>
    </ul>
    </div> 
</asp:Content>
