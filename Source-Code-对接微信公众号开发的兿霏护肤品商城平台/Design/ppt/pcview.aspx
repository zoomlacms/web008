<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pcview.aspx.cs" Inherits="ZoomLaCMS.Design.ppt.pcview" MasterPageFile="~/Common/Master/Empty2.master" %>
...
<iframe style="display:none;" src="/Com/CallCounter?ztype=ppt&id=<%:pageMod.ID %>&title=<%:pageMod.Title %>"></iframe>
