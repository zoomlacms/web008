...
- [Zoomla!逐浪CMS卓越出品](#zoomla逐浪cms卓越出品)
  - [逐浪官方开源精品全站项目008-对接微信公众号开发的兿霏护肤品商城平台](#逐浪官方开源精品全站项目008-对接微信公众号开发的兿霏护肤品商城平台)
  - [本项目介绍](#本项目介绍)
- [开放性说明](#开放性说明)
  - [使用说明](#使用说明)
- [接口文档](#接口文档)
...
## 逐浪官方开源精品全站项目008：-对接微信公众号开发的兿霏护肤品商城平台
...
这是一个-对接微信公众号开发的兿霏护肤品商城平台，移动优先，全面支持响应式，其特征包括：
- 服务端基于Zoomla!逐浪CMS开发
- 前端web呈现基于Boostrap 
- 支持chrome和现代化浏览器，兼容IE11与EDGE浏览器
- 完美支持微信与小程序接入与二次开发
- 集成微信支付，大型门户应用，对接微信公众号。
- 系统支持分销管理，支持积分兑换商品等复杂功能。
